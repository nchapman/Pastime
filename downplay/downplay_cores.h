...
#ifndef DOWNPLAY_CORES_H
#define DOWNPLAY_CORES_H
...
enum downplay_cores_state
{
   DOWNPLAY_CORES_INACTIVE = 0,  /* nothing in flight; no splash needed */
   DOWNPLAY_CORES_AWAITING_LIST, /* buildbot list fetch is pending */
   DOWNPLAY_CORES_INSTALLING,    /* downloading cores one at a time */
   DOWNPLAY_CORES_DONE           /* all done (or cancelled); splash dismissed */
};
